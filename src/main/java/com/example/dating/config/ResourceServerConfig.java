...
import com.example.dating.config.security.CustomAuthenticationEntryPoint;
import com.example.dating.config.security.CustomAuthenticationFailEntryPoint;
import com.example.dating.config.security.JwtAuthenticationFilter;
...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers(HttpMethod.GET, "/*/posts/**", "/*/user/email/**").permitAll()
